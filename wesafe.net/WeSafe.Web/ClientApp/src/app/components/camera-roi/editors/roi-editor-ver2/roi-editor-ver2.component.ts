...
import { PrivateClientService } from 'src/app/services/private-client.service';
...
export class RoiEditorVer2Component implements OnInit {
    ...
    constructor(private dialog: MatDialog,
                private _recognitionObjectsService: RecognitionObjectsService,
    ...
    ngOnInit() {
        ...
        this._recognitionObjectsService.getRecognitionObjects(true).subscribe(data => {
    ...
    addArea() {
        const dialogRef = this.dialog.open(AreaFormComponent, {
            ...
            data: {
                ...
                area: {
                    name: '',
                    type: (this.deviceType === DeviceTypeEnum.PeopleRecognition) ? 'perimeter' : 'entryline',
                    recognitionObjects: []
                }
            }
        });
        ...
        dialogRef.afterClosed().subscribe(result => {
            ...
            const area = {
                ...
                type: result.type,
                points: [],
                recognitionObjects: result.recognitionObjects
            };
    ...
    editArea(area) {
        ...
        dialogRef.afterClosed().subscribe(result => {
            ...
            area.recognitionObjects = result.recognitionObjects;
        });
    }
