...
import {
    ...
    ISchedulerRule,
    Scheduler,
    WeekDaysHoursSchedulerRule,
    WeekDaysHoursSchedulerRuleType
...
export class CameraEditComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.create) {
            ...
            this.camera.schedule = JSON.stringify(DefaultScheduler);
            this.buildMatrix(JSON.parse(this.camera.schedule));
